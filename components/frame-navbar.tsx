  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto h-full px-6 flex items-center justify-between">
        ...
        >
          <div className="relative w-8 h-8 rounded-full overflow-hidden border border-slate-300 group-hover:scale-105 transition-transform shadow-sm">
            <Image
          ...
          <div>
            <span className="font-bold text-slate-900 text-xs sm:text-sm tracking-tight group-hover:text-cyan-700 transition-colors">
              {personalInfo.name}
            </span>
            <span className="text-[10px] text-cyan-700 block font-mono font-medium leading-none">
              Java Developer
            </span>
          </div>
        </button>
        ...
        <div className="hidden md:flex items-center gap-3">
          <nav className="flex items-center gap-1 bg-white/80 backdrop-blur-md px-2.5 py-1 rounded-full border border-slate-200/80 shadow-sm">
            {MILESTONES.map((m) => {
          ...
          <a
            ...
            className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-slate-900 hover:bg-slate-800 text-white text-xs font-mono font-medium transition-all shadow-sm"
          >
        ...
        <button
          ...
          className="md:hidden p-1.5 rounded-xl bg-white/80 text-slate-800 border border-slate-200 shadow-sm"
