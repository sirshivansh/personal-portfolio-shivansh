  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-auto max-w-sm sm:max-w-md lg:max-w-lg w-full bg-white/95 backdrop-blur-xl border border-slate-200/90 shadow-xl shadow-slate-900/5 p-7 sm:p-8 rounded-3xl space-y-4 text-left">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-cyan-50 border border-cyan-200 text-cyan-800 font-sans font-semibold text-[0.75rem] tracking-[0.1em] uppercase shadow-sm">
          <Sparkles className="w-3.5 h-3.5 animate-pulse text-amber-500" />
          <span>Available for Opportunities</span>
        </div>

        <h1 className="font-serif font-bold text-slate-900 text-3xl sm:text-4xl lg:text-5xl leading-snug tracking-normal">
          Hi, I'm {personalInfo.name}
        </h1>

        <p className="text-sm sm:text-base text-slate-800 font-semibold leading-normal">
          {personalInfo.title}
        </p>
        ...
        <div className="flex flex-wrap items-center gap-3 pt-2">
          <a
            href="#projects"
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-bold transition-all shadow-md shadow-cyan-500/20 active:scale-95 text-xs"
          >
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-slate-100 hover:bg-slate-200 text-slate-900 font-semibold border border-slate-300 transition-all active:scale-95 text-xs shadow-sm"
          >
      ...
      {/* BOTTOM SCROLL HINT */}
      <div className="absolute bottom-6 left-6 lg:left-14 pointer-events-auto">
